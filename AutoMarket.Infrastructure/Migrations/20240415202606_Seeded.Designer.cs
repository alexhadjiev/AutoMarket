...
namespace AutoMarket.Infrastructure.Migrations
{
    ...
    [Migration("20240415202606_Seeded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Favorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Seller", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a80a8556-90f8-4a98-9c11-fca8ab27f534",
                            Email = "seller@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "seller@mail.com",
                            NormalizedUserName = "seller@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAENTxCzWX03wQTWllYNKC0wkHnwkI5vISoqSXfRAW7gSZnVA0CYbJN/wyzcWHw7bX8Q==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1e11051a-b142-4440-8a62-72448b259883",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "753785b0-4fa0-467d-ab0e-3f125a89e6a9",
                            Email = "guest@mail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "guest@mail.com",
                            NormalizedUserName = "guest@mail.com",
                            PasswordHash = "AQAAAAEAACcQAAAAEFP4hPZqTESOJWk7WPajivqTIy4Fw+XD7BO0kWl1N0kXztqDQfjguNSbVoldWdUscw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2e72fb42-575a-4638-8436-522d8348fef7",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Car", b =>
                {
                    b.HasOne("AutoMarket.Infrastructure.Data.Models.Category", "Category")
                        .WithMany("Cars")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AutoMarket.Infrastructure.Data.Models.Seller", "Seller")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("AutoMarket.Infrastructure.Data.Models.Comment", b =>
                {
                    b.HasOne("AutoMarket.Infrastructure.Data.Models.Car", "Car")
                        .WithMany("Comments")
                        .HasForeignKey("CarId")
